Ext.define("PVNApp", {
    ...
    description: "<strong>Velocity (Stories)</strong><br/>" +
            "<br/>" +
    ...
    _getSeries: function(artifacts_by_timebox) {
            ...
            Ext.Object.each(artifacts_by_timebox, function (key, value) {
            	...
            	datapoints.push({
    				...
    				events: {
       					click: function () {
       						me.showDrillDown(this._records.all,  "Stories for " + key + " - Total Points: " + Ext.util.Format.number(this.y, '0'));
       					}
    				}      		
            	});
            });
